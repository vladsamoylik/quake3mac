...
#define VERTEX_BUFFER_SIZE_HI  (16 * 1024 * 1024) /* increased for Apple M-series with large VRAM */

#define STAGING_BUFFER_SIZE    (4 * 1024 * 1024)  /* by default - increased for larger textures */
#define STAGING_BUFFER_SIZE_HI (96 * 1024 * 1024) /* enough for 8K texture size upload with all mip levels at once */

#define IMAGE_CHUNK_SIZE (256 * 1024 * 1024) // Increased for 8K textures: sqrt(256MB/4) = 8192px
