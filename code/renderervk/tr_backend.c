...
void VK_SelectTexture( int unit )
{
	...
	{
		ri.Error( ERR_DROP, "VK_SelectTexture: unit = %i", unit );
	}
...
** VK_Cull
*/
void VK_Cull( cullType_t cullType ) {
...
{
	// Vulkan state is managed through render passes and pipelines
	glState.glStateBits = stateBits;
}


static void RB_SetVK2D( void );
