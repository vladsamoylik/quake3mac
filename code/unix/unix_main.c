...
#include "unix_glw.h"  // for glw_state and declarations

// Forward declaration if not in header
void IN_Frame( void );
#endif

// Stub for InitSig - was in linux_signals.c which we removed
// macOS doesn't need Linux-specific signal handling
void InitSig( void )
{
	// macOS signal handling is handled by SDL
}
